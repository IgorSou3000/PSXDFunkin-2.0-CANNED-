	...
	//Fallthrough
		...
		case MenuPage_Story:
		{
			static const struct
			{
				...
				{NULL, StageId_1_4, "TUTORIAL", {"TUTORIAL", NULL, NULL, NULL}},
				{"1", StageId_1_1, "DADDY DEAREST", {"BOPEEBO", "FRESH", "DADBATTLE", NULL}},
				{"2", StageId_2_1, "SPOOKY MONTH", {"SPOOKEEZ", "SOUTH", "GHASTLY", "MONSTER"}},
				{"3", StageId_3_1, "PICO", {"PICO", "PHILLY NICE", "BLAMMED", NULL}},
				{"4", StageId_4_1, "MOMMY MUST MURDER", {"SATIN PANTIES", "HIGH", "AWOOGA", "MILF"}},
				{"5", StageId_5_1, "RED SNOW", {"GREEN EGGS", "HAM", "FEASTER", NULL}},			
			};
		...
		case MenuPage_Freeplay:
		{
			static const struct
			{
				...
				{StageId_2_3, 0xFF223344, "GHASTLY", 3},
				{StageId_2_4, 0xFF223344, "MONSTER", 7},
				...
				{StageId_4_3, 0xFFFC96D7, "AWOOGA", 5},
				{StageId_4_4, 0xFFFC96D7, "MILF", 5},
				{StageId_5_1, 0xFFA0D1FF, "GREEN EGGS", 6},
				{StageId_5_2, 0xFFA0D1FF, "HAM", 6},
				{StageId_5_3, 0xFFA0D1FF, "FEASTER", 7},
				{StageId_Bonus1_1, 0xFFA0D1FF, "TOO SLOW", 7},
				{StageId_Bonus1_2, 0xFFA0D1FF, "ENDLESS", 7},
				{StageId_Bonus1_3, 0xFFA0D1FF, "CYCLES", 7},
				{StageId_Bonus1_4, 0xFFA0D1FF, "MILK", 7},
				{StageId_Bonus2_1, 0xFFA0D1FF, "DGUY", 7},
				{StageId_Bonus2_2, 0xFFA0D1FF, "LORE", 7},
				{StageId_Bonus3_1, 0xFFA0D1FF, "GOD FEAST", 7},
			};
